...
const SearchPage = ({ handleSubmit, destinationOpts, initialValues }) => {
  return (
          ...
          render={({ handleSubmit }) => (
            <div>
              <StyledForm onSubmit={handleSubmit} id='form'>
                <StyledColumn>
                  <Field validate={isRequired} fullWidth component={FinalField} options={destinationOpts} type='autocomplete' name='destination' label='Destination' />
